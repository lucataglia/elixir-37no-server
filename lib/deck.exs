defmodule Deck do
  ...
  def factory,
    do: %{
      ...
      jh: %{key: "jh", label: "Jack of Hearts", suit: "hearts", pretty: "J♥️", ranking: 5, sort_id: 5, points: 0.33, used: false},
      qh: %{key: "qh", label: "Queen of Hearts", suit: "hearts", pretty: "Q♥️", ranking: 6, sort_id: 6, points: 0.33, used: false},
      kh: %{key: "kh", label: "King of Hearts", suit: "hearts", pretty: "K♥️", ranking: 7, sort_id: 7, points: 0.33, used: false},
      ah: %{key: "ah", label: "Ace of Hearts", suit: "hearts", pretty: "A♥️", ranking: 8, sort_id: 8, points: 1, used: false},
      "2h": %{key: "2h", label: "Two of Hearts", suit: "hearts", pretty: "2♥️", ranking: 9, sort_id: 9, points: 0.33, used: false},
      "3h": %{key: "3h", label: "Three of Hearts", suit: "hearts", pretty: "3♥️", ranking: 10, sort_id: 10, points: 0.33, used: false},
      ...
      jd: %{key: "jd", label: "Jack of Diamonds", suit: "diamonds", pretty: "J♦️", ranking: 5, sort_id: 15, points: 0.33, used: false},
      qd: %{key: "qd", label: "Queen of Diamonds", suit: "diamonds", pretty: "Q♦️", ranking: 6, sort_id: 16, points: 0.33, used: false},
      kd: %{key: "kd", label: "King of Diamonds", suit: "diamonds", pretty: "K♦️", ranking: 7, sort_id: 17, points: 0.33, used: false},
      ad: %{key: "ad", label: "Ace of Diamonds", suit: "diamonds", pretty: "A♦️", ranking: 8, sort_id: 18, points: 1, used: false},
      "2d": %{key: "2d", label: "Two of Diamonds", suit: "diamonds", pretty: "2♦️", ranking: 9, sort_id: 19, points: 0.33, used: false},
      "3d": %{key: "3d", label: "Three of Diamonds", suit: "diamonds", pretty: "3♦️", ranking: 10, sort_id: 20, points: 0.33, used: false},
      ...
      jc: %{key: "jc", label: "Jack of Clubs", suit: "clubs", pretty: "J♣️", ranking: 5, sort_id: 25, points: 0.33, used: false},
      qc: %{key: "qc", label: "Queen of Clubs", suit: "clubs", pretty: "Q♣️", ranking: 6, sort_id: 26, points: 0.33, used: false},
      kc: %{key: "kc", label: "King of Clubs", suit: "clubs", pretty: "K♣️", ranking: 7, sort_id: 27, points: 0.33, used: false},
      ac: %{key: "ac", label: "Ace of Clubs", suit: "clubs", pretty: "A♣️", ranking: 8, sort_id: 28, points: 1, used: false},
      "2c": %{key: "2c", label: "Two of Clubs", suit: "clubs", pretty: "2♣️", ranking: 9, sort_id: 29, points: 0.33, used: false},
      "3c": %{key: "3c", label: "Three of Clubs", suit: "clubs", pretty: "3♣️", ranking: 10, sort_id: 30, points: 0.33, used: false},
      ...
      js: %{key: "js", label: "Jack of Spades", suit: "spades", pretty: "J♠️", ranking: 5, sort_id: 35, points: 0.33, used: false},
      qs: %{key: "qs", label: "Queen of Spades", suit: "spades", pretty: "Q♠️", ranking: 6, sort_id: 36, points: 0.33, used: false},
      ks: %{key: "ks", label: "King of Spades", suit: "spades", pretty: "K♠️", ranking: 7, sort_id: 37, points: 0.33, used: false},
      as: %{key: "as", label: "Ace of Spades", suit: "spades", pretty: "A♠️", ranking: 8, sort_id: 38, points: 1, used: false},
      "2s": %{key: "2s", label: "Two of Spades", suit: "spades", pretty: "2♠️", ranking: 9, sort_id: 39, points: 0.33, used: false},
      "3s": %{key: "3s", label: "Three of Spades", suit: "spades", pretty: "3♠️", ranking: 10, sort_id: 40, points: 0.33, used: false}
    }
